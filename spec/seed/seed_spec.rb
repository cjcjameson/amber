...
describe Seed do
	context "#genres" do
		...
		it "creates BeerGenre objects when passed a valid json formatted string" do
			genre_string = '[{"name": "Cream Ale","description": "Smooth malty sweetness and balanced bitterness. Pairs perfectly with sweet, hot, or spicy foods including many Asian dishes, chili, mango or jalapeño salsa."}]'
